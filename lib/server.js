...
var targetApi = require('./targetApi')
var decisionApi = require('./decisionApi')
...
router.set('/api/targets/get', { GET: targetApi.getTargets })
router.set('/api/targets/put', { POST: targetApi.postTarget })
router.set('/api/target/get/:id', { GET: targetApi.getTargetById })
router.set('/api/target/put/:id', { POST: targetApi.updateTargetById })
router.set('/route/put', { POST: decisionApi.getDecision })
