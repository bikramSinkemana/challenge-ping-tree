...
router.set('/targets/get', { GET: targetApi.getTargets })
router.set('/targets/put', { POST: targetApi.postTarget })
router.set('/targets/get/:id', { GET: targetApi.getTargetById })
router.set('/targets/put/:id', { POST: targetApi.updateTargetById })
